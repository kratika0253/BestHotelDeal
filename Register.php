	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="login1.php" id="form1">
					...
					<div class="wrap-input100 validate-input" data-validate = "Length of only 10 digits is required.">
					...
					<div class="wrap-input100 validate-input" data-validate="Password and Confirm Password should have the same value.">
				...
				<div class="login100-more" style="background-image: url('Login-images/hello.jpg');">
						<div class="col-xs-2">
